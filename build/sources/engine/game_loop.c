...
int	game_loop(void *arg)
{
	...
	// cube->delta_time = ((current_time - cube->last_frame_time) / 10.0);
	// effective_move_speed = cube->player.move_speed * (cube->delta_time + 1);
	// effective_rot_speed = cube->player.rot_speed * (cube->delta_time + 1);
...
// {
// 	if (cube->key_w)
// 		move_player_forward(cube, effective_move_speed);
// 	if (cube->key_s)
// 		move_player_backward(cube, effective_move_speed);
// 	if (cube->key_a)
// 		move_player_left(cube, effective_move_speed);
// 	if (cube->key_d)
// 		move_player_right(cube, effective_move_speed);
// 	if (cube->key_lar)
// 		shift_view_left(cube, effective_rot_speed);
// 	if (cube->key_rar)
// 		shift_view_right(cube, effective_rot_speed);
// }
